...
def molecular_hamiltonian_coefficients(nuclear_repulsion,
    ...
    # # Dimension of the loopss
    # Dim = 2 * one_body_integrals.shape[0]
    ...
    if restricted:
        ...
        one_body_coefficients = restricted_to_unrestricted(one_body_integrals)
        # cast 2 electron integral to physicist's order
        two_body_coefficients = restricted_to_unrestricted(
            torch.permute(two_body_integrals, (0,2,3,1)))
